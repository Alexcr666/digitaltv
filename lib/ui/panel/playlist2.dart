                        ...
                        child: _PlaylistRow(
                          ...
                          onCopyLink: () {
                            ...
                            ScaffoldMessenger.of(context)
                                .showSnackBar(_snackEC('Link copiado'));
                          },
                          onDelete: () =>
  ...
  Widget _searchBox() => Container(
        ...
        child: TextField(
          ...
          decoration: const InputDecoration(
            ...
            prefixIcon:
                Icon(Icons.search_rounded, size: 16, color: _EC.textMid),
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                      color: sel ? _EC.primary.withOpacity(0.2) : _EC.border,
                      borderRadius: BorderRadius.circular(10)),
                  child: Text('$count',
                      style: TextStyle(
...
class _PlaylistRowState extends State<_PlaylistRow> {
  ...
  Widget build(BuildContext context) {
    ...
    return MouseRegion(
      ...
      child: AnimatedContainer(
        ...
        padding: EdgeInsets.symmetric(
            vertical: widget.isNarrow ? 2 : 2, horizontal: 4),
        color: _hovered ? _EC.primary.withOpacity(0.04) : Colors.transparent,
    ...
    return Container(
      ...
      child: Row(
        children: [
                ...
                Row(
                  children: [
                    ...
                    Text(widget.fmtDate(pl.createdAt),
                        style:
                            const TextStyle(color: _EC.textMid, fontSize: 11)),
                  ],
                ),
              ],
            ),
          ...
          // Acciones
          if (widget.isConfirming) _confirmDelete() else _actionBtns(),
        ],
      ),
    );
  }
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('$clipsCount clips • ${widget.fmtDate(pl.createdAt)}',
                        style:
                            const TextStyle(color: _EC.textMid, fontSize: 10)),
                  ],
                ),
              ),
            ],
  ...
  Widget _confirmDelete() => Row(
        ...
        children: [
          const Text('¿Eliminar?',
              style: TextStyle(
                  color: _EC.red, fontSize: 11, fontWeight: FontWeight.w600)),
          const SizedBox(width: 8),
          GestureDetector(
        ...
        child: MouseRegion(
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              height: 32,
              decoration: BoxDecoration(
                  color: _hovered ? widget.color.withOpacity(0.15) : _EC.card,
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(
                      color: _hovered
