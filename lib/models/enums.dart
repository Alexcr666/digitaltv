...
enum AppRole {
  ...
  static AppRole fromString(String s) => AppRole.values
      .firstWhere((r) => r.value == s, orElse: () => AppRole.user);
...
enum AppPermission {
  ...
  String get label => switch (this) {
        ...
        AppPermission.settingsEdit => '⚙️ Editar configuración',
  ...
  String get description => switch (this) {
        ...
        AppPermission.notificationsSend =>
          'Puede enviar notificaciones a usuarios',
        ...
        AppPermission.dashboardGlobal =>
          'Acceso al dashboard global del sistema',
        AppPermission.dashboardCompany =>
          'Acceso al panel de control de la empresa',
      };
}
